...
//        cookiecheck.checkCookie(request);
    ...
    private String signup(@PathVariable String storeSN, @Valid CustomerCreateForm customerCreateForm, BindingResult bindingResult, HttpServletResponse response) {
